_: {
  # Git configuration
  xdg.configFile = {
    "git/private.signers".text = "selfuryon@gmail.com ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPmB+ZN4UTQ+5IOvGrlBoHrCxfpQH7EWtLNR3qUrnQl5 selfuryon@github [private]";
